...
//validar horario
		...
		//VERIFICAR NA TABELA HORARIOS AGD SE TEM O HORARIO NESSA DATA
			...
			if($esconder == "" and $esconder2 == "" and $esconder3 == ""){
				$total_horarios += 1;
			}
			...
			<div class="col-md-2 <?php echo $ocultar ?> <?php echo $agendado ?> <?php echo $agendado_agd ?>">

				<div class="form-check">

					<input onchange="abrirModal('<?php echo $hora ?>');" class="form-check-input" type="radio" name="hora" value="<?php echo $hora ?>" <?php echo $checado ?> <?php echo $checado2 ?> <?php echo $checado3 ?>>
...
<p style="margin-left: 10px"><small>Total de Horários Disponíveis: <?php echo $total_horarios ?></small></p>