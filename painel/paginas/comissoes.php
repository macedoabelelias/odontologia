...
<div class="bs-example widget-shadow" style="padding:15px">
	<div class="row">
		<div class="col-md-5" style="margin-bottom:5px;">
			...
			<select class="form-control sel200" id="funcionario" name="funcionario" style="width:100%;" onchange="listar()"> 
...
<div class="modal fade" id="modalBaixarTudo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		...
		<div class="modal-header bg-primary text-white">
				<h4 class="modal-title" id="exampleModalLabel">Pagar Comissões: <span id="titulo_inserir"></span></h4>
			...
			<div class="modal-body">
					...
					<div class="col-md-8">
							<div class="form-group">
								...
								<select class="form-select" id="pgto_baixar_todas" name="pgto" style="width:100%;" required> 
									<?php 
...
<div class="modal fade" id="modalDados" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
							...
							<div class="table-responsive">
								<table id="" class="text-left table table-bordered">
									...
									<tr>
										...
										<td><span id="tipo_chave_dados"></span> <span id="chave_pix_dados"></span></td>
									</tr>
	...
	<div class="modal fade" id="modalBaixar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header bg-primary text-white">
				<h4 class="modal-title" id="exampleModalLabel">Baixar Conta<span id="descricao-baixar"></span></h4>
